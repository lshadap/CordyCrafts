...
The keys live in `.claude/settings.json` (project) or `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/settings.json` (global) — **not** in `.planning/config.json`:
