...
```
Task(
  prompt="Read /Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/get-shit-done/templates/SECURITY.md`
