...
- **Global scope**: `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/notes/`)
...
2. Glob `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/notes/` — works in any directory
