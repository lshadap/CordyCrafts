...
- Usage: Reference from command with `@/Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/lambertshadap/Personal/PersonalVentures/CordyCrafts/CordyCrafts/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
